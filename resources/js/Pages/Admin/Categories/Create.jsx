...
export default function CategoryCreate() {
    ...
    return (
        <>
            ...
            <Head title="Create Category - EasyPOS" />
                ...
                <div className="container-fluid py-4">
                    <div className="saas-page-header saas-card">
                        <div className="saas-header-left">
                            ...
                            <div>
                                <h5 className="saas-title">Tambah Kategori</h5>
                                <p className="saas-subtitle">
                                    Add and manage product category for your
                                    system
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    ...
                                    placeholder="Masukan keterangan (Optional)"
